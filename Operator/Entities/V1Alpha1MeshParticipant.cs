    ...
    V1Alpha1MeshParticipant.V1Alpha1MeshParticipantStatus>
{
    ...
    public class V1Alpha1MeshParticipantSpec
    {
        ...
        /// A valid participant must respect the HTTP_PROXY environment variable.
        /// </summary>
        [AdditionalPrinterColumn]
        public string Deployment { get; set; } = string.Empty;

        /// <summary>
        /// The port of the deployed application should receive the communication.
        /// </summary>
        ...
        /// <summary>
        /// Defines environment variables that are passed to the translator for configuration.
        /// </summary>
